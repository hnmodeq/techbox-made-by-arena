...
export function Dropdown({ trigger, items, align="end" }: { 
 ...
 className="w-full text-right px-3 py-2 text-[length:var(--paragraph-font-size)] text-[var(--paragraph-color)] rounded-[var(--tb-radius-md)] hover:bg-[var(--tb-bg-muted)] transition-colors"
 >{it.label}</button>
 ))}
 </div>
 )}
