...
export const ChipButton = React.forwardRef<HTMLButtonElement, ChipButtonProps>(
 ...
 type="button"
 className={cn(
 "inline-flex items-center justify-center gap-1 rounded-[var(--corner-radius)] border px-3 py-1.5 text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] ",
