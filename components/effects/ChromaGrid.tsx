 ...
 >
        {data.map((c, i) => (
          <article
            ...
            className={`group relative flex flex-col w-[300px] h-[360px] overflow-hidden border-[length:var(--border-size)] border-transparent transition-colors duration-300 rounded-[var(--corner-radius)] ${c.url ? "cursor-pointer" : ""}`}
            style={
              {
