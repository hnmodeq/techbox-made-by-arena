...
export default function WorkWithUs(){
 ...
 <div>
 <h3 className=" text-[length:var(--font-size-h2)] text-[var(--h2-font-color)] font-bold group-hover:text-[var(--home)]">{j.title}</h3>
 <p className="text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] text-muted-foreground mt-1">{j.excerpt}</p>
 ...
 <div className="text-left text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] text-muted-foreground">
 {j.date_fa}
