...
function AdminPostsInner() {
 ...
 return <main className="p-10 text-center" dir="rtl"><p className="text-[var(--tb-danger)]">شما دسترسی به ماژول {moduleMeta[module]?.titleFa} ندارید.</p><p className="mt-3 text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">دسترسی شما: {user.modules.join(", ")}</p></main>;
 }
 ...
 <div>
 <h1 className="text-[length:var(--font-size-h1)] text-[var(--h1-font-color)] font-extrabold ">مدیریت محتوا</h1>
 ...
 <div className="text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">نتیجه فعلی</div>
 <div className="mt-1 text-[length:var(--font-size-h2)] text-[var(--h2-font-color)] font-bold ">{filteredItems.length.toLocaleString("fa-IR")}</div>
 </div>
 <div className="card p-3">
 <div className="text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">بازدیدها</div>
 <div className="mt-1 text-[length:var(--font-size-h2)] text-[var(--h2-font-color)] font-bold ">{stats.views.toLocaleString("fa-IR")}</div>
 </div>
 <div className="card p-3">
 <div className="text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">پسندها</div>
 <div className="mt-1 text-[length:var(--font-size-h2)] text-[var(--h2-font-color)] font-bold ">{stats.likes.toLocaleString("fa-IR")}</div>
 </div>
 <div className="card p-3">
 <div className="text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">برچسب یکتا</div>
 <div className="mt-1 text-[length:var(--font-size-h2)] text-[var(--h2-font-color)] font-bold ">{stats.tagCount.toLocaleString("fa-IR")}</div>
 </div>
 </div>
 ...
 <table className="w-full min-w-[760px] text-[length:var(--font-size-h3)] text-[var(--h3-font-color)] font-semibold">
 <thead className="bg-[var(--muted-background)]/40 text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">
 <tr>
 ...
 <div className="mt-1 font-mono text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color" dir="ltr">/{module}/{it.slug}</div>
 <div className="mt-2 flex flex-wrap gap-1 lg:hidden">
 {it.tags.slice(0, 3).map(t => <span key={t} className="rounded-[var(--corner-radius)] border border-[var(--border-color)] bg-transparent px-2 py-0.5 text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">{t}</span>)}
 </div>
 </td>
 ...
 <td className="hidden p-3 align-top text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] lg:table-cell">
 <div>{it.date_fa}</div>
 <div className="mt-1 paragraph-color">{it.author.name}</div>
 </td>
 <td className="p-3 align-top text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)]">
 ...
 <div className="p-8 text-center text-[length:var(--font-size-h3)] text-[var(--h3-font-color)] font-semibold paragraph-color">
 ...
 <p className="mt-4 text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">
