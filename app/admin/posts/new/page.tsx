...
function NewPostInner() {
 ...
 <h1 className="text-[length:var(--font-size-h1)] text-[var(--h1-font-color)] font-extrabold ">{editSlug ? "ویرایش مطلب" : "مطلب جدید"}</h1>
 <p className="mt-1 text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">{user.name} • {user.role==="super_admin"?"مدیر کل":"ویراستار"}</p>
 </div>
 ...
 <div>
 <label className="text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">ماژول *</label>
 ...
 <div>
 <label className="text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">دسته‌بندی</label>
 ...
 <div>
 <label className="text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">عنوان *</label>
 <input value={title} onChange={e=>setTitle(e.target.value)} className="input mt-1" required />
 </div>

 <div className="grid gap-3 md:grid-cols-[minmax(0,1fr)_auto] md:items-end">
 <div>
 <label className="text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">اسلاگ</label>
 ...
 <div>
 <label className="text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">خلاصه</label>
 ...
 <label className="text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">برچسب‌ها – با , جدا کنید</label>
 <input value={tags} onChange={e=>setTags(e.target.value)} className="input mt-1" placeholder="QNAP-2277, nas, storage" />
 </div>
 <div>
 <label className="text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">تصویر شاخص URL</label>
 <input value={image} onChange={e=>setImage(e.target.value)} className="input mt-1" placeholder="/assets/..." dir="ltr" />
 </div>
 </div>

 <div>
 <label className="text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">محتوا</label>
 ...
 <div className={`text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] ${statusClass}`}>
 {msg || "POST → /api/posts – RBAC server-side؛ در خطا، پیش‌نویس لوکال ذخیره می‌شود."}
 {lastDraftKey && <span className="block text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">کلید پیش‌نویس: <code>{lastDraftKey}</code></span>}
 </div>
 ...
 <h2 className="text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] ">پیش‌نمایش منبع</h2>
 <div className="mt-3 space-y-2 text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">
 ...
 {parsedTags.slice(0, 8).map(t => <span key={t} className="rounded-[var(--corner-radius)] border border-[var(--border-color)] px-2 py-0.5 text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">{t}</span>)}
 {parsedTags.length > 8 && <ModuleBadge module="info">+{(parsedTags.length-8).toLocaleString("fa-IR")}</ModuleBadge>}
 </div>
 </div>

 <div className="card p-4 text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">
 ...
 <p className="mt-3 text-center text-[length:var(--font-size-paragraph)] text-[var(--paragraph-color)] paragraph-color">
 دسترسی شما:
