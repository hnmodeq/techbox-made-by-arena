...
export default function ModuleList({ module }: { module: ModuleSlug }) {
 ...
 <div>
 <h1 className={`text-[length:var(--h1-font-size)] font-extrabold text-[var(--h1-font-color)] ${meta.color}`}>{meta.titleFa}</h1>
 <p className="text-[length:var(--h3-font-size)] font-semibold text-[var(--h3-font-color)] text-muted-foreground mt-2">{items.length} مطلب • مرتب‌سازی تازه‌ترین</p>
 </div>
