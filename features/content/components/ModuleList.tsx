...
export default function ModuleList({ module }: { module: ModuleSlug }) {
 ...
 <div>
 <h1 className={`h1-font-size h1-font-color font-extrabold ${meta.color}`}>{meta.titleFa}</h1>
 <p className="h3-font-size h3-font-color font-semibold text-muted-foreground mt-2">{items.length} مطلب • مرتب‌سازی تازه‌ترین</p>
 </div>
 <Link href="/" className="paragraph-font-size paragraph-color text-muted-foreground hover:text-foreground">خانه →</Link>
 </div>
