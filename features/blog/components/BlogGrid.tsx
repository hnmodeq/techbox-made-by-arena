        ...
        {items.map(p=>(
          ...
          >
            ...
            <div className="p-4 flex flex-col flex-1">
              <h3 className="h2-font-size h2-font-color font-bold line-clamp-2 min-h-[56px] transition-colors group-hover:text-[var(--tb-blog)]">{p.title}</h3>
              <p className="paragraph-font-size paragraph-color text-[var(--paragraph-color)] line-clamp-3 mt-2 flex-1">{p.excerpt}</p>
              <div className="flex items-center justify-between mt-4 pt-3 border-t border-[color-mix(in_oklch,var(--border-color)_50%,transparent)] paragraph-font-size paragraph-color text-[var(--paragraph-color)]">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-[var(--primary-text)] paragraph-font-size paragraph-color">{p.author.name}</div>
                    <div>{p.date_fa}</div>
                  </div>
                </div>
