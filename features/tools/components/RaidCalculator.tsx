...
export default function RaidCalculator(){
 ...
 <h3 className=" text-[length:var(--h2-font-size)] font-bold text-[var(--h2-font-color)] text-[var(--tb-raid)]">RAID Calculator</h3>
 ...
 <div className="grid sm:grid-cols-3 gap-3 text-[length:var(--h3-font-size)] font-semibold text-[var(--h3-font-color)]">
