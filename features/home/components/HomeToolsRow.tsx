        ...
        <div className="pt-6 border-t-[length:var(--border-size)] border-[var(--border-color)] flex flex-col items-center justify-center gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10 w-full max-w-3xl">
            <Link
              ...
              className="group flex items-center justify-center gap-2 text-[var(--nas)] font-black text-sm sm:text-base hover:scale-105 transition-all duration-300 py-2"
            >
            ...
            <Link
              ...
              className="group flex items-center justify-center gap-2 text-[var(--nvr)] font-black text-sm sm:text-base hover:scale-105 transition-all duration-300 py-2"
            >
            ...
            <Link
              ...
              className="group flex items-center justify-center gap-2 text-[var(--subnet)] font-black text-sm sm:text-base hover:scale-105 transition-all duration-300 py-2"
            >
