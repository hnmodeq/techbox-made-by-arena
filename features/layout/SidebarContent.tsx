...
import SidebarTooltip from "@/features/layout/SidebarTooltip";
...
export default function SidebarContent({
  ...
  const cart = (()=>{ try{ const { useCart:uc } = require("@/features/shop/hooks/cart-context"); return null;}catch{return null} })();
  // useCart must be inside a client that is under CartProvider – Sidebar is under CartProvider via LayoutShell – safe:
  let cartCount = 0;
  try { /* eslint-disable-next-line react-hooks/rules-of-hooks */ const { count } = require("@/features/shop/hooks/cart-context").useCart(); cartCount = count; } catch {}
