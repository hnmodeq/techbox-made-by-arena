export const moduleColors = {
  ...
  blog: {
    ...
    indicator: "bg-orange-400 dark:bg-orange-300",
  },
  news: {
    base: "text-foreground",
  ...
  media: {
    ...
    indicator: "bg-amber-300 dark:bg-amber-200",
  },
  shop: {
    base: "text-foreground",
  ...
  tools: {
    ...
    indicator: "bg-cyan-300 dark:bg-cyan-200",
  },
  forum: {
    base: "text-foreground",
    hover: "group-hover:text-rose-300",
    active: "text-rose-300 dark:text-rose-200",
    indicator: "bg-rose-300 dark:bg-rose-200",
  },
  review: {
    base: "text-foreground",
  ...
  download: {
    ...
    indicator: "bg-pink-400 dark:bg-pink-300",
  },
  account: {
    base: "text-foreground",
    hover: "group-hover:text-red-200",
    active: "text-red-200 dark:text-red-300",
    indicator: "bg-red-200 dark:bg-red-300",
  },
} as const;
